Public Class frm_relat_clientes
    Private Sub frm_relat_clientes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            'TODO: esta linha de código carrega dados na tabela 'FarmarioDataSet.tb_clientes'. Você pode movê-la ou removê-la conforme necessário.
            Me.Tb_clientesTableAdapter.Fill(Me.FarmarioDataSet.tb_clientes)
